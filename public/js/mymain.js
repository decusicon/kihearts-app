...
function createCampaignModal() {
  ...
  createCampaignBtn.click((e) => {
    ...
    $(".createCampaign #createCampaignForm").attr("action", "/campaigns/create")
...
function referralFunctions() {
  ...
  const generateAndDisplayLink = () => {
    var referralLinkElems = document.querySelectorAll("[data-referral-link]")
    ...
    if (referralLinkElems) {
      referralLinkElems.forEach((referralLinkElem) => {
        if (referralLinkElem.hasAttribute("data-copy-text")) {
          referralLinkElem.setAttribute("data-copy-text", referralLink)
        } else {
